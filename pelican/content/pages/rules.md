...
Статьи, набранные в системе LaTeX2e (MIKTEX, WinEdit) с использованием стилевого файла, необходимо прислать до **20 ноября** по электронной почте или на указанный адрес оргкомитета. Решение о публикации статей, подготовленных в иных редакторах, будет приниматься индивидуально.
